 ...
 * {} e
 * {} não estão retornando nada, pois
...
public class Principal {
    public static void main(String[] args) {
        ...
        var cotacaoYahoo = servico.getCotacao("MGLU3.SA"); //MGLU3 = Magazine Luiza


        servico = new AlphaAdapter();
        var cotacaoAlpha = servico.getCotacao("INTL");//INTL = Intel

        servico = new QuandlAdapter();
        var cotacaoQuandl = servico.getCotacao("WIKI/AAPL"); //AAPL = Apple
